  ...
  <div class="container">
    ...
    <div class="row position-relative">
      ...
      <div class="col-lg-7 about-img" data-aos="zoom-out" data-aos-delay="200"><img
          src="admin/uploads/<?php echo $rowAbout['image']; ?>"></div>

      <div class="col-lg-7" data-aos="fade-up" data-aos-delay="100">
        <h2 class="inner-title"><?php echo $rowAbout['title']; ?></h2>
        <div class="our-story">
          <?php echo nl2br($rowAbout['content']); ?>
        </div>
      </div>
...
<section id="clients" class="clients section">
  ...
  <div class="container" data-aos="fade-up" data-aos-delay="100">
    ...
    <div class="row g-0 clients-wrap">
      <?php if (!empty($rowClients)): ?>
        <?php foreach ($rowClients as $client): ?>
          <?php if (!empty($client['image'])): ?>
            <img src="admin/uploads/<?php echo htmlspecialchars($client['image']); ?>" style="max-width: 200px"
              alt="<?php echo htmlspecialchars($client['name'] ?? 'Client'); ?>">
          <?php endif; ?>
        <?php endforeach; ?>
      <?php else: ?>
